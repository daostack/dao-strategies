...
type CampaignConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: CampaignConstructorParams): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;
...
export class Campaign__factory extends ContractFactory {
  ...
  deploy(overrides?: Overrides & { from?: string | Promise<string> }): Promise<Campaign> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): Campaign {
