...
export interface CampaignFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'campaignAddress', values: [BytesLike]): string;
  encodeFunctionData(functionFragment: 'createCampaign', values: [BytesLike, BytesLike, BytesLike, string, string, BigNumberish, BytesLike]): string;

  decodeFunctionResult(functionFragment: 'campaignAddress', data: BytesLike): Result;
...
export interface CampaignFactory extends BaseContract {
  ...
  estimateGas: {
    campaignAddress(salt: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    campaignAddress(salt: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
