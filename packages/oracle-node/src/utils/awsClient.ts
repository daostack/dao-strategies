...
const uploadLogoToS3 = async (uri: string, currentTime: number, logoBuffer: Buffer): Promise<string> => {
    if (!uri) throw new Error("Cant upload logo to s3, uri paramter not given for this operation")
