...
export class EthCampaignFactory extends ethereum.SmartContract {
  static bind(address: Address): EthCampaignFactory {
    return new EthCampaignFactory("EthCampaignFactory", address);
  }
