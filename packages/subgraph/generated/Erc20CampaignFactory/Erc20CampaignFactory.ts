...
export class Erc20CampaignFactory extends ethereum.SmartContract {
  static bind(address: Address): Erc20CampaignFactory {
    return new Erc20CampaignFactory("Erc20CampaignFactory", address);
  }
